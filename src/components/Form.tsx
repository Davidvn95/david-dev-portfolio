...
export default function Form() {
  ...
  return (
    <div class="w-full flex justify-center">
      {isLoading && (
        <div class="absolute w-full h-[100vh] flex justify-center items-center gap-6">
          <span class="relative flex h-4 w-4 justify-center items-center">
            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400"></span>
      ...
      <form
        ...
        class="grid place-items-center w-full max-w-2xl">
        <fieldset class="grid shadow-md border-[.5px] border-slate-400 dark:border-slate-800 dark:bg-transparent dark:shadow-slate-600 dark:shadow-sm rounded-2xl p-5 w-full place-items-center">
          <legend class="font-semibold text-amber-600 dark:text-amber-500 text-xl p-1 rounded-lg">
        ...
        <button
          id="send"
          type="submit"
          class="px-3 py-2 mt-3 text-sm font-semibold text-center inline-flex items-center transition ease-in delay-150 hover:text-slate-900 border-2 border-amber-400 hover:border-transparent hover:bg-amber-400 rounded-md">
